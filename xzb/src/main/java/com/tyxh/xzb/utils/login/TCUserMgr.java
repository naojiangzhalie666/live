package com.tyxh.xzb.utils.login;
...
import com.tyxh.xzb.utils.GenerateTestUserSig;
...
import com.tyxh.xzb.utils.roomutil.NameGenerator;
...
//                loginMLVB();
        ...
        liveRoom.login(loginInfo, new IMLVBLiveRoomListener.LoginCallback() {
            ...
            public void onError(int errCode, String errInfo) {
                ...
                if(mOnLoginBackListener!=null){
                    mOnLoginBackListener.onLoginFailedListener(errCode,errInfo);
                }
    ...
    public abstract static class OnLoginBackListener{
