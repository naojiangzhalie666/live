...
//        mShortcutArea = findViewById(R.id.shortcut_area);
    ...
    protected void assembleActions() {
        ...
        if (mEnableVideoCall) {
            action.setIconResId(R.drawable.talk_media);
        ...
        if (mEnableAudioCall) {
            ...
            action.setIconResId(R.drawable.talk_talk);
        ...
        if (!mSendPhotoDisable) {
            action = new InputMoreActionUnit();
            action.setIconResId(R.drawable.talk_photo);
        ...
        if (!mCaptureDisable) {
            action = new InputMoreActionUnit();
            action.setIconResId(R.drawable.talk_camera);
  ...
  /*      if (TUIKit.getConfigs().isEnableGroupLiveEntry() && mChatInfo != null && mChatInfo.getType() != V2TIMConversation.V2TIM_C2C) {
    ...
    protected abstract void startCzZuans();
