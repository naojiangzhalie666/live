...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    private boolean can_caozuo = true;
    private boolean show_zdy = false;
    private String ms_one, ms_two;
    ...
    public void setShow_zdy(boolean show_zdy, String ms_one, String ms_two) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            tvMs_one = view.findViewById(R.id.pic_miaoshuone);
            tvMs_two = view.findViewById(R.id.pic_miaoshutwo);
        }
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            if (show_zdy) {
                ...
                viewHolder.tvMs_one.setText(ms_one);
                viewHolder.tvMs_two.setText(ms_two);
