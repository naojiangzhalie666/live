...
public class MEIZUPushReceiver extends MzPushMessageReceiver {
    ...
    public void onMessage(Context context, String s) {
        LiveLog.i(TAG, "onMessage method1 msg = " + s);
    }

    @Override
    public void onMessage(Context context, String message, String platformExtra) {
        LiveLog.i(TAG, "onMessage method2 msg = " + message + ", platformExtra = " + platformExtra);
    }

    @Override
    public void onMessage(Context context, Intent intent) {
        String content = intent.getExtras().toString();
        LiveLog.i(TAG, "flyme3 onMessage = " + content);
    }
    ...
    public void onNotificationClicked(Context context, MzPushMessage mzPushMessage) {
        LiveLog.i(TAG, "onNotificationClicked mzPushMessage " + mzPushMessage.toString());
    }
    ...
    public void onRegisterStatus(Context context, RegisterStatus registerStatus) {
        LiveLog.i(TAG, "onRegisterStatus token = " + registerStatus.getPushId());
