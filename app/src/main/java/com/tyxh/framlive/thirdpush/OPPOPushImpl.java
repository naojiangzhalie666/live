...
public class OPPOPushImpl implements ICallBackResultService {
    ...
    public void onRegister(int responseCode, String registerID) {
        LiveLog.i(TAG, "onRegister responseCode: " + responseCode + " registerID: " + registerID);
    ...
    public void onUnRegister(int responseCode) {
        LiveLog.i(TAG, "onUnRegister responseCode: " + responseCode);
    }

    @Override
    public void onSetPushTime(int responseCode, String s) {
        LiveLog.i(TAG, "onSetPushTime responseCode: " + responseCode + " s: " + s);
    }

    @Override
    public void onGetPushStatus(int responseCode, int status) {
        LiveLog.i(TAG, "onGetPushStatus responseCode: " + responseCode + " status: " + status);
    }

    @Override
    public void onGetNotificationStatus(int responseCode, int status) {
        LiveLog.i(TAG, "onGetNotificationStatus responseCode: " + responseCode + " status: " + status);
    }
