...
public class MessageNotification {
    ...
    private Context mContext = LiveApplication.getmInstance();

    private MessageNotification() {
        mManager = (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        if (mManager == null) {
            LiveLog.e(TAG, "get NotificationManager failed");
            return;
        }
    ...
    private void createNotificationChannel(boolean isDialing) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (isDialing) {
                channel = new NotificationChannel(NOTIFICATION_CHANNEL_CALL,mContext.getString(R.string.call_notification), NotificationManager.IMPORTANCE_HIGH);
                channel.setSound(RingtoneManager.getDefaultUri(RingtoneManager.TYPE_RINGTONE), null);
                channel.setDescription(mContext.getString(R.string.background_tip));
                channel.setVibrationPattern(new long[]{0, 1000, 1000, 1000, 1000});
            } else {
                channel = new NotificationChannel(NOTIFICATION_CHANNEL_COMMON, mContext.getString(R.string.new_msg_notification), NotificationManager.IMPORTANCE_HIGH);
                channel.setDescription(mContext.getString(R.string.background_tip));
            }
    ...
    public void notify(V2TIMMessage msg) {
        ...
        LiveLog.e(TAG, "isDialing: " + isDialing);
        ...
        if (isDialing) {
            ...
            launch.putExtra(Constant.CHAT_INFO, callModel);
            ...
            launch.putExtra(Constant.CHAT_INFO, chatInfo);
            launch.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        }
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
                ...
                mHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        builder.setContentText(mContext.getString(R.string.call_nos));
