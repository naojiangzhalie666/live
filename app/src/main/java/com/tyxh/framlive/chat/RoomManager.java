...
import com.tyxh.framlive.base.GenerateTestUserSig;
        ...
        okHttpClient.newCall(request)
                .enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        ...
                        if (callback != null) {
                            callback.onFailed(ERROR_CODE_UNKNOWN, LiveApplication.getmInstance().getString(R.string.unknow_error));
                        }
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (!response.isSuccessful()) {
                            doFailed(ERROR_CODE_UNKNOWN, LiveApplication.getmInstance().getString(R.string.unknow_error));
                            return;
                        }
