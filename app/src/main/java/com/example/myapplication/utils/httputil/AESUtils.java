...
import com.example.myapplication.utils.httputil.old.Base64;
...
public class AESUtils {
    ...
    public static final String DEFAULT_SECRET_KEY = "EDACDD5B3000392207DCFBE5023E4063";
    ...
    public static void main(String[] args) {
        ...
        String encryptDbPwd =encrypt(DEFAULT_SECRET_KEY, dbPassword);
        System.out.println("encrypt: " + encryptDbPwd);

        String decrypt = decrypt(DEFAULT_SECRET_KEY, "U9X5p9prv8cZc3kN3X2Vir3NFSQimkFXrJbVxgRM/GvZ48CufHtA8d7muufb3tkSBd/l/wmdjw9hKyk+eqt+Qs3wr338HKElFpdi5SoFllKDilIIAOEdE9Kc42wGcv5DJFgVdIyQrAbJ7g9orIsgQg==");
