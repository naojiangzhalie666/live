package com.example.myapplication.utils.WheelPicker.widget;
...
import com.example.myapplication.utils.Common.util.ConvertUtils;
import com.example.myapplication.utils.Common.util.LogUtils;
import com.example.myapplication.utils.WheelPicker.entity.WheelItem;
...
public class WheelView extends View {
    ...
    public static final int DIVIDER_ALPHA = 0;
    ...
    private static final int VELOCITY_FLING = 3;//修改这个值可以改变滑行速度
