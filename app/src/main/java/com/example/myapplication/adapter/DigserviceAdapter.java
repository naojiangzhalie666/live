...
public class DigserviceAdapter extends RecyclerView.Adapter<DigserviceAdapter.ViewHolder> {
    ...
    public DigserviceAdapter(Context context, List<String> stringList) {
        mContext = context;
        mLists = stringList;
    ...
    public void onBindViewHolder(ViewHolder vh, int position) {
        ...
        Glide.with(mContext).load(R.drawable.mine_bg).apply(new RequestOptions().transform(roundedCorners)).into(vh.mItemServiceHead);
        vh.mItemServiceTitle.setText("看见你手机"+position);
        vh.mItemServiceNum.setText("10"+position);
